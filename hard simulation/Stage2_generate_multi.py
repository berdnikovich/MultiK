...
CL = int(sys.argv[2])
ConstMulti_for_RNAmulti = int(sys.argv[3])
ConstMulti_for_DNAmulti = int(sys.argv[4])
ConstMulti_for_DNAmultiRNAmulti = int(sys.argv[5])
libName = '2stage{}'.format("{}_{}_{}".format(str(ConstMulti_for_RNAmulti), str(ConstMulti_for_DNAmulti), str(ConstMulti_for_DNAmultiRNAmulti)))
