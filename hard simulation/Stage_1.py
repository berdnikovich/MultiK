...
distrib_path = sys.argv[2]
BL = int(sys.argv[3])#500000
CL = int(sys.argv[4])#64444167
...
global result_distrib
result_distrib = os.path.join(distrib_path, "{}_s5_prior.mhic".format(BL//1000))
######
##visualisation
#global pic1
...
#######find new distrib
with open(result_distrib, "r") as distr_f:
    x = []
    y = []
    for i in distr_f:
        i_=i.strip().split("\t")
